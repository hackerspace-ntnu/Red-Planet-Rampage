...
////TODO: deal with composites that have parts bound in different control schemes
    /// <summary>
    /// A reusable component with a self-contained UI for rebinding a single action, copied from the action map example project and updated to use
    /// Text mesh pro instead.
    /// </summary>
    public class KeyMappingButton : MonoBehaviour
    {
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<KeyMappingButton>();
        ...
        private static List<KeyMappingButton> s_RebindActionUIs;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<KeyMappingButton, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<KeyMappingButton, InputActionRebindingExtensions.RebindingOperation>
        {
        }
}
...
////TODO: support multi-object editing
    ...
    /// </summary>
    [CustomEditor(typeof(KeyMappingButton))]
    public class KeyMappingButtonEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
