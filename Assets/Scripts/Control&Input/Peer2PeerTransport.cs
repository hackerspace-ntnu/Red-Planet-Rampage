...
public class Peer2PeerTransport : NetworkTransport
{
    /// <summary>
    ...
    class ServerCallbacks : ISocketManager
    {
        ...
        public ServerCallbacks(Peer2PeerTransport transport)
        {
